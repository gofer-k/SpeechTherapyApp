...
fun LanguageSelectorPreview() {
    val language = MutableStateFlow(Language.ENGLISH) // Default selected language
    LanguageSelector(listOf(Language.ENGLISH, Language.POLISH), language, onSelectedLanguage = {})
}